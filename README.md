# 🏆| Neste repositório, você vai conhcecer todas às conquistas no GitHub, e como coletar cada uma delas: 
  ...
  ### 🥇| No total são 9 conquistas disponíveis para serem coletadas no GitHub, já que 2 não estão mais disponíveis para serem coletadas. 
  Para cada conquista vamos ter: nome > imagem > explicação de como coleta-la!
...
Para conseguir a conquista Quickdraw, você precisa mesclar uma pull request de um repositório forkado.
...
Para obter a conquista Galaxy Brain, você precisa habilitar discussões no seu repositório e criar uma pergunta ou responder uma. É necessário fazer isso duas vezes para obter a conquista.
...
` Co-authored-by: nome da pessoa <email_da_pessoa@mail.com> `
...
Conquista rara que não pode mais ser obtida. Foi concedida a quem contribuiu com código para repositórios usados na [2020 GitHub Archive Program](https://archiveprogram.github.com/)
...
Outra conquista rara que não pode mais ser obtida. Foi concedida a quem Contribuiu para repositórios usados na [Missão de Helicóptero Mars 2020](https://github.com/readme/featured/nasa-ingenuity-helicopter).
...
Se seguir o passo a passo acima irá coletar as conquistas.
